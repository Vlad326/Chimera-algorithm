...
def print_training_info(img_size):
    ...
    print("- Размер датасета: 100 train, 13 validation")
    print(f"- Размер изображения: {img_size}")
    print("- Batch size: 6")
    print("- Эпохи: 300")
    print("- Используется агрессивная аугментация")
    print("- Автоматический подбор оптимизатора (AdamW)")
    print("=" * 50)
...
if __name__ == "__main__":
    ...
    data_yaml = "C:/Users/User\PycharmProjects\PythonProject\Project/algoritmXimeraV1\Yolov8/ultilites\JustTrain\TrainingYoloOBBModel\datasets\Rubezh\data.yaml"
